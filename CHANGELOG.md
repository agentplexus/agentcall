...
- IRC chat provider for bidirectional channel and DM messaging

### Added

- IRC chat provider configuration with TLS and NickServ support ([`62def1b`](https://github.com/plexusone/agentcomms/commit/62def1b))
- IRC provider initialization in chat manager ([`9783f52`](https://github.com/plexusone/agentcomms/commit/9783f52))

### Dependencies

- Update omnichat to v0.5.0 with IRC provider (ergochat/irc-go v0.6.0) ([`2101d6f`](https://github.com/plexusone/agentcomms/commit/2101d6f))

### Documentation

- IRC setup guide with server configuration and authentication ([`1dfb824`](https://github.com/plexusone/agentcomms/commit/1dfb824))
- IRC configuration options in configuration.md ([`1dfb824`](https://github.com/plexusone/agentcomms/commit/1dfb824))
...
[unreleased]: https://github.com/plexusone/agentcomms/compare/v0.5.0...HEAD
[v0.5.0]: https://github.com/plexusone/agentcomms/compare/v0.4.0...v0.5.0
